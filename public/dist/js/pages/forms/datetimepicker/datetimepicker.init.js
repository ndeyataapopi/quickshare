...
$('.pickadate-translations').pickadate({
    ...
    monthsFull: ['Janvier', 'FÃƒÂ©vrier', 'Mars', 'Avril', 'Mai', 'Juin', 'Juillet', 'AoÃƒÂ»t', 'Septembre', 'Octobre', 'Novembre', 'DÃƒÂ©cembre'],
...
$('.localeRange').daterangepicker({
    ...
    locale: {
        ...
        monthNames: ['Janvier', 'fÃƒÂ©vrier', 'Mars', 'Avril', 'ÃÅ“ÃÂ°i', 'Juin', 'Juillet', 'AoÃƒÂ»t', 'Septembre', 'Octobre', 'Novembre', 'Decembre'],
        firstDay: 1
    }
});
