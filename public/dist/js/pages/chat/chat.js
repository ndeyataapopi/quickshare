...
$('.message-type-box').on('keydown', function(event) {
    if(event.key === 'Enter') {
        ...
        $messageHtml = '<li class="odd chat-item"> <div class="chat-content"><div class="box bg-light-success"><h5 class="font-medium">Genelia</h5><p class="font-light mb-0">' + chatMessageValue + '</p><div class="chat-time">'+ time +'</div> </div></div><div class="chat-img"><img src="../assets/images/users/2.jpg" alt="user"></div> </li>';
